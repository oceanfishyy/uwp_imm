...
using UWP_Ocean.UserControls;
using Windows.UI.Xaml;
using Windows.UI.Xaml.Controls;

namespace UWP_Ocean.Common
{
    public class CNavigationService : INavigationService
    {
        /// <summary>
        ...
        public void GoBack()
        {
            ...
            //if (frame is MainPage)
            //{
            //    ((Frame)((MainPage)frame).FindName("mainFrame")).Navigate(_pagesByKey[pageKey], parameter);
            //}
            var frame = ((Frame)((MainPage)Window.Current.Content).FindName("mainFrame"));
            //var frame = ((Frame)Window.Current.Content);
